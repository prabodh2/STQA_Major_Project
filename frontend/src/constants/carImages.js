// Default car images from Unsplash (free to use, reliable CDN)
...
// Get a random car image from the array
export const getRandomCarImage = () => {
  const randomIndex = Math.floor(Math.random() * DEFAULT_CAR_IMAGES.length);
  return DEFAULT_CAR_IMAGES[randomIndex];
};
